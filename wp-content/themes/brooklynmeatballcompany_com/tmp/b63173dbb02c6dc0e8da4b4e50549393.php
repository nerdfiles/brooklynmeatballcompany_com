...
?><!--Charset  --><meta charset="utf-8" /><!--Title  --><title>
  ...
  <?php echo javascript_include_tag("http://use.edgefonts.net/lobster.js"); ?>

  <?php echo javascript_include_tag("http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.6.1/modernizr.min.js"); ?>
