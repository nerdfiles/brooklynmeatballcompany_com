...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Subscript Box:</strong></span>
<br />
This option will enable the Subscript Box.  This button will be added to row three of the visual editor.
