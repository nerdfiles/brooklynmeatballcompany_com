<html><head>
<title>YouTube iFrame Box</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>YouTube iFrame Box:</strong></span>
<br />
This option will enable the YouTube iFrame Box.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
This button basically functions the same way as the previous (older) version of the YouTube button, with the exception that this button uses the newer iFrame feature.<br /><br />

Simply copy the (long link) url of the YouTube video to be inserted.  Choose your size from one of the presets, or customize your own.<br /><br />
