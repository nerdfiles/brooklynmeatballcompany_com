<html><head>
<title>W3C Validate Button</title>
...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>W3C Validate Button:</strong></span>
<br />
This option will enable the W3c Validate button.

<br /><br />

<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Usage:</strong></span>
<br />
This button will check the content of the tinymce editor against the chosen validation method.<br /><br />

Use this button as a final check to make sure all code is compliant with browsers and crawlers.<br /><br />
