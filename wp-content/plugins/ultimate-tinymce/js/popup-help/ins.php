...
<span class="title" style="padding:0px 5px 0px 5px;background-color:#CCFCD9;border:1px solid #339966;"><strong>Insert Box:</strong></span>
<br />
This option will enable the Insert Box.  This button will be added to row four of the visual editor.
...
Insertion allows you to note changes to your posts.  Syntactically, it will add an underline across the selected text.  It will also add a hover tooltip, with a description you enter.  Here is an example:
<br /><br />
<img src="images/insertion.png" border="1px solid #000000" /><br />
<em>The popup box where you can enter your hover description (Title), any custom styling, and a note.</em><br /><br />

<img src="images/insertion2.png" border="1px solid #000000" /><br />
